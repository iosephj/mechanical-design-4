...
### Trabajo práctico 1: Tuerca de aluminio

En este trabajo practicarás cortar con la sierra sin fin, agujerear y roscar con macho en aluminio.

##### Actividad

Dibuja el croquis y escribe el procedimiento según la figura de abajo. Estamos usando rosca Witworth y ten en cuenta lo siguiente para la acotación:

- Hay que poner el tipo de rosca, el diámetro y el paso (en hilos por pulgada), ver aquí: [⌕](../../images/tp1/thread-dimensioning-1.png)
- La flecha, como es una tuerca se representa como se muestra aquí: [⌕](../../images/tp1/thread-dimensioning-2.png)

<!-- Image -->
<br>
   <center>![](tp1/croquis.jpg){width=400px}</center>
   <center>
